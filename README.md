...
<div align="center">
  ...
  ![Anilist Anilist](https://github.com/lowlighter/metrics/blob/examples/metrics.plugin.anilist.svg)

  ![Anilist Manga](https://github.com/lowlighter/metrics/blob/examples/metrics.plugin.anilist.manga.svg)